...
hs.hotkey.bind({'ctrl', 'cmd'}, "w", function() toggleApp("com.tencent.xinWeChat") end)
-- hs.hotkey.bind(myhyper, ",", function() toggleApp("com.apple.MobileSMS") end)
hs.hotkey.bind({'ctrl', 'cmd'}, "e", function() toggleApp("com.tencent.qq") end)
hs.hotkey.bind(myhyper, ",", function() toggleApp("com.mathworks.matlab") end)
hs.hotkey.bind(myhyper, "`", function() toggleApp("info.sioyek.sioyek") end)
hs.hotkey.bind(myhyper, "a", function() toggleApp("com.microsoft.VSCode") end)
hs.hotkey.bind(myhyper, "e", function() toggleApp("com.apple.Preview") end)
hs.hotkey.bind(myhyper, "q", function() toggleApp("net.sourceforge.skim-app.skim") end)
...
hs.hotkey.bind(myhyper, "u", function() toggleApp("com.apple.Safari") end)
